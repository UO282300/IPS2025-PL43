    ...
    private void procesarDevolucionProfesor(double cantidad, LocalDate fecha, int idFactura) {
        ...
        if (cantidad > netoActual + 0.01) {
            ...
            int opcion = JOptionPane.showConfirmDialog(
                ...
                String.format(
                    " Devolución excesiva.\n\n" +
                    "El exceso de %.2f € se registrará como un importe que el profesor deberá abonar posteriormente.\n\n" +
                    "¿Desea continuar?",
                    cantidad, netoActual, exceso
                ),
            ...
            if (opcion != JOptionPane.YES_OPTION) {
                JOptionPane.showMessageDialog(
                    this,
                    "Operación cancelada. No se registró la devolución.",
                    "Cancelado",
        ...
        if (diferenciaAntes > 0.01) {
            int opcion = JOptionPane.showConfirmDialog(
                this,
                String.format("Se está devolviendo %.2f € más de lo que corresponde.\n¿Desea continuar con la devolución de %.2f €?", cantidad - diferenciaAntes, cantidad),
