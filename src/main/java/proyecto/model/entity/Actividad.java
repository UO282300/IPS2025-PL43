...
public class Actividad {
    ...
    public void setId_Actividad(int i) { this.id_Actividad = i; }
    ...
    public LocalDate getInicio_insc() { return inicio_insc; }
    public void setInicio_insc(LocalDate inicio_insc) { this.inicio_insc = inicio_insc; }

    public LocalDate getFin_inscr() { return fin_inscr; }
    public void setFin_inscr(LocalDate fin_inscr) { this.fin_inscr = fin_inscr; }

    public double getCuota() { return cuota; }
    public void setCuota(double cuota) { this.cuota = cuota; }

    public boolean isEs_gratuita() { return es_gratuita; }
    public void setEs_gratuita(boolean es_gratuita) { this.es_gratuita = es_gratuita; }

    public int getId_profesor() { return id_profesor; }
    public void setId_profesor(int i) { this.id_profesor = i; }
    ...
    public String toString() {
        return "Nombre: " + getNombre() + 
               " --------------  Objetivo : " + getObjetivos() + 
               " -------------- FECHA : " + getFechaInicio() + " - " + getFechaFin() + 
               " | " + getHoraInicio() + "--" + getHoraFin();
    }
}
